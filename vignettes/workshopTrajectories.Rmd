...
```{r clean, eval = FALSE, echo = FALSE}
rm(counts, rd, phenoData, filt)
```
...
plot(reducedDim(sce, "UMAP")[shuffle, ],
...
names(sce) <- cds@featureData$gene_short_name[which(filt)]
